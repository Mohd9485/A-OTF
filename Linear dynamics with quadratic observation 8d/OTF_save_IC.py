...
# -*- coding: utf-8 -*-
"""
Created on Fri May  2 18:29:01 2025
...
def OTF_param(Y,X0_const,parameters,A,h,t,tau,Noise):
    Odeint = False
    AVG_SIM = X0_const.shape[0]
    L = X0_const.shape[1]
    N = Y.shape[1]
    dy = Y.shape[2]
    SAMPLE_SIZE = X0_const.shape[2]
    noise = Noise[0]
...
# =============================================================================
            ...
            loss_f.backward()
            optimizer_f.step()
            if  (i+1)==iterations or i%10000==0:
                with torch.no_grad():
                    f_of_xy = f.forward(X_Train,Y_Train) 
...
# =============================================================================
    ...
    # =============================================================================
        ...
        convex_f = NeuralNet(INPUT_DIM, int(NUM_NEURON/1))
        MAP_T = T_NeuralNet(INPUT_DIM, int(NUM_NEURON/1))
        
        # convex_f.apply(init_weights)
        # MAP_T.apply(init_weights)    
        
        OT_param_dict = np.load('./DATA_XX/DATA_file_param_IC.npz',allow_pickle=True)['OT_param_dict'].tolist()[0]
        f_param_dict = np.load('./DATA_XX/DATA_file_param_IC.npz',allow_pickle=True)['f_param_dict'].tolist()[0]
        MAP_T.load_state_dict(OT_param_dict)
        convex_f.load_state_dict(f_param_dict)
...
# =============================================================================
            Y1 = h(X1.T).T + eta_train
            
            SAVE_all_X_prior.append(copy.deepcopy(X1))
            SAVE_all_Y_prior.append(copy.deepcopy(Y1))
# =============================================================================
#             print( h(X1.T))
# =============================================================================
...
# =============================================================================
            ...
            f_param.append(copy.deepcopy(convex_f.state_dict()))
            MAP_T_param.append(copy.deepcopy(MAP_T.state_dict()))
    ...
    return SAVE_all_X_OT, MAP_T_param, f_param