...
# -*- coding: utf-8 -*-
"""
Created on Thu May  8 16:22:06 2025
...
# -*- coding: utf-8 -*-
"""
Created on Thu May  8 15:37:41 2025
...
# parameters['LearningRate'] = 1e-3 # 1e-3
# parameters['ITERATION'] = int(1024) # 1e4

t = np.arange(0.0, tau*N, tau)

# MU_0 = [1,5]
# MU_0 = [10,8,6,4,2,0]
MU_0 = [1.0,0.8,0.6,0.4,0.2,0] 
...
for mu_0 in MU_0:
    ...
    for k in range(AVG_SIM):    
        X0[k,] = mu_0 + x0_amp*np.transpose(np.random.multivariate_normal(np.zeros(L),sigmma0*sigmma0 * np.eye(L),J))
