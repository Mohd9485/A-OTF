...
parameters['ITERATION'] = int(1024*1/1) # 64
...
J_list = [int(10**i) for i in range(6,1,-1)] # Number of ensembles 
...
plt.legend(loc=1,fontsize=20, bbox_to_anchor=(0.8, 0.7))
