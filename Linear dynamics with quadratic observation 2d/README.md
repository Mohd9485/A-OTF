...
- 'main.py': Run the code using the distance matrix D and generate the left panel in Figure 2.
- 'main_compute_time.py': Generate the $W_2$ distance as a function of $N$ and computational time in the right panel of Figure 2.
