...
def OTF(Y,X0_C,parameters,A,h,t,tau,Noise,Odeint):
    # np.random.seed(0)
    # torch.manual_seed(0)
...
# =============================================================================
    ...
    class NeuralNet(nn.Module):
            ...
            def __init__(self, input_dim, hidden_dim):
                ...
                # self.layer41 = nn.Linear(self.hidden_dim, self.hidden_dim, bias=True)
                # self.layer42 = nn.Linear(self.hidden_dim, self.hidden_dim, bias=True)
...
# =============================================================================
        ...
        optimizer_T = torch.optim.Adam(T.parameters(), lr=learning_rate/5) # *10
...
# =============================================================================
    ...
    return SAVE_all_X_OT.transpose(0,1,3,2),time.time() - start_time