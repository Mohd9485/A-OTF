...
# -*- coding: utf-8 -*-
"""
Created on Wed Feb  5 16:27:27 2025
...
def OTF_param(Y,X0_C,parameters,A,h,t,tau,Noise,Odeint):
...
# =============================================================================
        ...
        optimizer_T = torch.optim.Adam(T.parameters(), lr=learning_rate/10) # *10
...
# =============================================================================
    ...
    return SAVE_all_X_OT.transpose(0,1,3,2), SAVE_all_X_prior,SAVE_all_Y_prior, MAP_T_param