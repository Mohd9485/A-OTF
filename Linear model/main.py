...
from OT_norm import OT_norm
from scipy.integrate import odeint
from KF import KF
# from OT_nearest import OT_nearest

from OT_nearnest_MMD_no_train import OT_nearest_MMD
from OT_nearnest_W2_no_train import OT_nearest_W2
...
for k in Num_selected_maps:
    print(k)
    # S = select_maps_fun(k,method='d_t') # method='d_mmd',d_w2,d_t default : d_t
    ...
    X_OT_nearest,distance,nearest_index,t_nearest = OT_nearest_W2(Y_True,X0,parameters,A,h,t,tau,Noise,nearest=False) # nearest=False for weithed maps 
    # X_OT_nearest,distance,nearest_index,t_nearest = OT_nearest_MMD(Y_True,X0,parameters,A,h,t,tau,Noise,nearest=False) # nearest=False for weithed maps
...
X_OT, time_OT = OT_norm(Y_True,X0,parameters,A,h,t,tau,Noise)
...
for num_plot_state in range(1,2):
    ...
    for n in range(N):
        ...
        # density, _ = np.histogram(X_KF[0,:,num_plot_state,][n], bins=position_bins, density=True)
    ...
    # plt.savefig('./save_figs/X_W2_weighted_dist.pdf')