...
for k in Num_selected_maps:
    ...
    X_OT_nearest,distance,nearest_index,t_nearest = A_OTF_W2(Y_True,X0,parameters,A,h,t,tau,Noise,nearest=False) # nearest=False for weithed maps 
    # X_OT_nearest,distance,nearest_index,t_nearest = A_OTF_MMD(Y_True,X0,parameters,A,h,t,tau,Noise,nearest=False) # nearest=False for weithed maps
